...
SOURCES = {
    ...
    'cinder-base': {
        ...
        'location': ('$tarballs_base/cinder/'
                     'cinder-11.0.0.0rc2.tar.gz')},
    'congress-base': {
        'type': 'url',
        'location': ('$tarballs_base/congress/'
                     'congress-6.0.0.0rc1.tar.gz')},
    'cloudkitty-base': {
        'type': 'url',
    ...
    'freezer-api': {
        ...
        'location': ('$tarballs_base/freezer-api/'
                     'freezer-api-5.0.0.0rc1.tar.gz')},
    'freezer-base': {
        'type': 'url',
        'location': ('$tarballs_base/freezer/'
                     'freezer-5.0.0.0rc1.tar.gz')},
    'glance-base': {
        'type': 'url',
        'location': ('$tarballs_base/glance/'
                     'glance-15.0.0.0rc2.tar.gz')},
    'gnocchi-base': {
        'type': 'git',
        'reference': '4.0.2',
    ...
    'heat-base': {
        ...
        'location': ('$tarballs_base/heat/'
                     'heat-9.0.0.0rc2.tar.gz')},
    'horizon': {
        'type': 'url',
        'location': ('$tarballs_base/horizon/'
                     'horizon-12.0.0.0rc2.tar.gz')},
    ...
    'horizon-plugin-designate-dashboard': {
        ...
        'location': ('$tarballs_base/designate-dashboard/'
                     'designate-dashboard-5.0.0.0rc1.tar.gz')},
    'horizon-plugin-freezer-web-ui': {
        'type': 'url',
        'location': ('$tarballs_base/freezer-web-ui/'
                     'freezer-web-ui-5.0.0.0rc1.tar.gz')},
    ...
    'horizon-plugin-mistral-dashboard': {
        ...
        'location': ('$tarballs_base/mistral-dashboard/'
                     'mistral-dashboard-5.0.0.0rc1.tar.gz')},
    ...
    'horizon-plugin-trove-dashboard': {
        ...
        'location': ('$tarballs_base/trove-dashboard/'
                     'trove-dashboard-9.0.0.0rc1.tar.gz')},
    ...
    'manila-base': {
        ...
        'location': ('$tarballs_base/manila/'
                     'manila-5.0.0.0rc1.tar.gz')},
    'mistral-base': {
        'type': 'url',
        'location': ('$tarballs_base/mistral/'
                     'mistral-5.0.0.0rc1.tar.gz')},
    ...
    'murano-base': {
        ...
        'location': ('$tarballs_base/murano/'
                     'murano-4.0.0.0rc2.tar.gz')},
    'neutron-base': {
        'type': 'url',
        'location': ('$tarballs_base/neutron/'
                     'neutron-11.0.0.0rc3.tar.gz')},
    'neutron-base-plugin-neutron-fwaas': {
        'type': 'url',
        'location': ('$tarballs_base/neutron-fwaas/'
                     'neutron-fwaas-11.0.0.0rc2.tar.gz')},
    ...
    'neutron-base-plugin-networking-sfc': {
        ...
        'location': ('$tarballs_base/networking-sfc/'
                     'networking-sfc-5.0.0.0rc2.tar.gz')},
    ...
    'neutron-server-ovn-plugin-networking-ovn': {
        ...
        'location': ('$tarballs_base/networking-ovn/'
                     'networking-ovn-3.0.0.0rc2.tar.gz')},
    'nova-base': {
        'type': 'url',
        'location': ('$tarballs_base/nova/'
                     'nova-16.0.0.0rc2.tar.gz')},
    ...
    'sahara-base': {
        ...
        'location': ('$tarballs_base/sahara/'
                     'sahara-7.0.0.0rc2.tar.gz')},
    'searchlight-base': {
        'type': 'url',
        'location': ('$tarballs_base/searchlight/'
                     'searchlight-3.0.0.0rc1.tar.gz')},
    'senlin-base': {
        'type': 'url',
        'location': ('$tarballs_base/senlin/'
                     'senlin-4.0.0.0rc1.tar.gz')},
    'solum-base': {
        'type': 'url',
    ...
    'watcher-base': {
        ...
        'location': ('$tarballs_base/watcher/'
                     'python-watcher-1.4.0.tar.gz')},
    'zaqar': {
        'type': 'url',
        'location': ('$tarballs_base/zaqar/'
                     'zaqar-5.0.0.0rc1.tar.gz')},
    'zun-base': {
        'type': 'url',
