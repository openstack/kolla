...
SOURCES = {
    ...
    'barbican-base': {
        ...
        'location': ('$tarballs_base/barbican/'
                     'barbican-8.0.1.tar.gz')},
    'bifrost-base': {
        'type': 'url',
        'location': ('$tarballs_base/bifrost/'
                     'bifrost-6.0.5.tar.gz')},
    'blazar-base': {
        'type': 'url',
    ...
    'horizon-plugin-neutron-lbaas-dashboard': {
        ...
        'location': ('$tarballs_base/neutron-lbaas-dashboard/'
                     'neutron-lbaas-dashboard-6.0.1.tar.gz')},
    ...
    'horizon-plugin-octavia-dashboard': {
        ...
        'location': ('$tarballs_base/octavia-dashboard/'
                     'octavia-dashboard-3.1.0.tar.gz')},
    'horizon-plugin-sahara-dashboard': {
        'type': 'url',
        'location': ('$tarballs_base/sahara-dashboard/'
                     'sahara-dashboard-10.0.2.tar.gz')},
    ...
    'ironic-base': {
        ...
        'location': ('$tarballs_base/ironic/'
                     'ironic-12.1.6.tar.gz')},
    'ironic-inspector': {
        'type': 'url',
        'location': ('$tarballs_base/ironic-inspector/'
                     'ironic-inspector-8.2.5.tar.gz')},
    'karbor-base': {
        'type': 'url',
    ...
    'monasca-agent': {
        ...
        'location': ('$tarballs_base/monasca-agent/'
                     'monasca-agent-2.10.1.tar.gz')},
    'monasca-api': {
        'type': 'url',
        'location': ('$tarballs_base/monasca-api/'
                     'monasca-api-3.0.1.tar.gz')},
    'monasca-log-api': {
        'type': 'url',
    ...
    'monasca-notification': {
        ...
        'location': ('$tarballs_base/monasca-notification/'
                     'monasca-notification-1.17.1.tar.gz')},
    'monasca-persister': {
        'type': 'url',
    ...
    'sahara-base-plugin-mapr': {
        ...
        'location': ('$tarballs_base/sahara-plugin-mapr/'
                     'sahara-plugin-mapr-1.0.2.tar.gz')},
